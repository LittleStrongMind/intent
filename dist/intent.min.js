...
return f={all:function(){f.executionOf.close();f.executionOf.changes()},displayOf:{},executionOf:{close:function(){var a=function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;b.close()};b.DOM.actions.close.addEventListener("click",a);b.DOM.actions.cancel.addEventListener("click",a)},changes:function(){for(var f=a.get("input, textarea",b.DOM.form),c=function(){for(var a=!0,c=0;c<f.length;c++)a=a&&""!==f[c].value;null!==b.DOM.actions.submit&&(b.DOM.actions.submit.disabled=!a);b.form.submittable=
a},d=0;d<f.length;d++)f[d].addEventListener("input",c.bind(b,f[d]))}}}}}]);return c}(),g=function(){function c(b,a){var f=this;_classCallCheck(this,c);this.ID=d++;this.body=b||{};this.DOM=this.DOM();this.system=a;this.modal=this.system.modal;this.lastUpdated=new Date;if(!this.system)throw Error("Missing intent system.");this.listeners.all();setInterval(function(){f.updateDOMLastUpdate()},1E3)}_createClass(c,[{key:"timeSinceUpdate",value:function(){var b=Math.floor((new Date-this.lastUpdated)/1E3),
a=Math.floor(b/31536E3);if(1<a)return a+" years";a=Math.floor(b/2592E3);if(1<a)return a+" months";a=Math.floor(b/86400);if(1<a)return a+" days";a=Math.floor(b/3600);if(1<a)return a+" hours";a=Math.floor(b/60);return 1<a?a+" minutes":"seconds"}},{key:"updateDOMTitle",value:function(){this.DOM.title.innerHTML="\x3ca href\x3d'#'\x3e"+this.body.title+"\x3c/a\x3e"}},{key:"updateDOMLastUpdate",value:function(){this.DOM.updated.innerHTML=this.timeSinceUpdate()+" ago"}},{key:"DOM",value:function(){var b=
a.create("article","c-card");b.innerHTML='\n\n            \x3ch1 class\x3d"c-card__title"\x3e\x3ca href\x3d"#"\x3e'+this.body.title+'\x3c/a\x3e\x3c/h1\x3e\n\n            \x3caside class\x3d"c-card__meta"\x3e\n\n                \x3cdiv class\x3d"c-card__updated"\x3e\n                    \x3cspan class\x3d"c-card__updated__label"\x3eLast Updated\x3c/span\x3e\n                    \x3cspan class\x3d"c-card__updated__time js-updated-time"\x3eseconds ago\x3c/span\x3e\n                \x3c/div\x3e\n\n                \x3cdiv class\x3d"c-card__actions" role\x3d"navigation"\x3e\n\n                    \n                \x3csvg class\x3d"c-card__actions__edit" role\x3d"button" viewBox\x3d"0 0 24 24" xmlns\x3d"http://www.w3.org/2000/svg"\x3e\n                    \x3cpath d\x3d"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"\x3e\x3c/path\x3e\n                \x3c/svg\x3e\n            \n\n                    \n                \x3csvg class\x3d"c-card__actions__delete" role\x3d"button" viewBox\x3d"0 0 24 24" xmlns\x3d"http://www.w3.org/2000/svg"\x3e\n                    \x3cpath d\x3d"M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"\x3e\x3c/path\x3e\n                \x3c/svg\x3e\n            \n\n                \x3c/div\x3e\n            \x3c/aside\x3e\n\n            \x3caside class\x3d"c-card__warning"\x3e\n\n                \x3ch1 class\x3d"c-card__warning__title"\x3eYou are about to delete this intent. Are you sure?\x3c/h1\x3e\n\n                \x3cdiv class\x3d"c-card__warning__actions"\x3e\n                    \x3cbutton class\x3d"c-card__warning__actions__confirm c-button c-button--red"\x3eYes I am\x3c/button\x3e\n                    \x3cbutton class\x3d"c-card__warning__actions__cancel c-button c-button--purple"\x3eNo I\'m not\x3c/button\x3e\n                \x3c/div\x3e\n            \x3c/aside\x3e\n\n        ';
...
c.executionOf.deletion.shown=!0})},show:function(){b.DOM.title.addEventListener("click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;b.modal.open("view");b.modal.form.disable();b.modal.form.fill(b.body)})}}},executionOf:{deletion:{shown:!1,cancel:function(){if(!b.DOM.confirmation.cancel)throw Error("Missing cancel deletion button.");b.DOM.confirmation.cancel.addEventListener("click",function(){b.DOM.card.classList.remove("c-card--delete-flag");c.executionOf.deletion.shown=!1})},
confirm:function(){if(!b.DOM.confirmation.confirm)throw Error("Missing confirm deletion button.");b.DOM.confirmation.confirm.addEventListener("click",function(){c.executionOf.deletion.shown&&b.system.remove(b.ID)})}},edit:function(){b.modal.DOM.actions.edit.addEventListener("click",function h(c){c.preventDefault?c.preventDefault():c.returnValue=!1;b.modal.form.submittable&&(c=b.modal.form.data,c.expressions=a.stringToArray(c.expressions),b.body=c,b.updateDOMTitle(),b.lastUpdated=new Date,b.modal.close(h))})}}}}}]);
return c}();new (function(){function c(b){_classCallCheck(this,c);this.intents={};this.modal=new e;this.DOM={body:a.get("body"),container:a.get(b)};this.listeners.all()}_createClass(c,[{key:"add",value:function(b){var c=a.get(".js-anchor",this.DOM.container);if(b&&b.hasOwnProperty("ID"))this.intents[b.ID]=b;else throw Error("Insertion failed.");this.DOM.container.insertBefore(b.DOM.card,c)}},{key:"remove",value:function(a){var b=this.intents[a].DOM.card;delete this.intents[a];b.parentNode.removeChild(b)}},
{key:"listeners",get:function(){var b=this,c=null;return c={all:function(){c.displayOf.form();c.executionOf.create()},displayOf:{form:function(){var c=a.get(".c-new-intent-button");if(!c)throw Error("Missing new intent card button.");c.addEventListener("click",function(){b.modal.open("create")})}},executionOf:{create:function(){b.modal.DOM.actions.create.addEventListener("click",function(){event.preventDefault?event.preventDefault():event.returnValue=!1;if(b.modal.form.submittable){var c=b.modal.form.data;
c.expressions=a.stringToArray(c.expressions);b.add(new g(c,b));b.modal.close()}})}}}}}]);return c}())(".o-section")})(document);
